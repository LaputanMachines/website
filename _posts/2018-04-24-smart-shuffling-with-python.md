---
layout: post
title: Smart Shuffling RATM's 'Evil Empire' With Python
description: The shuffle feature in my car for CDs is inconvenient as it needs to be re-toggled after each power cycle, often glitches with specific CDs like Evil Empire, and sometimes plays the next track instead of shuffling properly. This frustration contrasts with Spotify's reliable shuffle function, which may be due to the large size of my playlists.
image: '/images/posts/2018-04-24-smart-shuffling-with-python/evil-empire.png'
tags: [python, music, programming, performance-tuning]
featured: false
---
